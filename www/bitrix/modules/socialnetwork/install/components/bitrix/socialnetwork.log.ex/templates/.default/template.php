	...
	if ($arParams["PUBLIC_MODE"] != "Y")
	{
		...
		if ($arParams["SHOW_REFRESH"] != "N")
		{
			...
			?><div onclick="oLF.refresh()" id="sonet_log_counter_2_container" class="feed-new-message-informer"><?
				...
				?></span><?
				?><span class="feed-new-message-inf-text feed-new-message-inf-text-waiting new-message-balloon" style="display: none;"><?
					?><span class="new-message-balloon-icon new-message-balloon-icon new-message-balloon-icon-rotating"></span><?
