...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproDigitalProfitReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproDigitalProfitReference', 'TABLE_NAME' => 'digital_profit_reference');
