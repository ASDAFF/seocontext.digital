...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproDigitalCompanyReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproDigitalCompanyReference', 'TABLE_NAME' => 'b_hlbd_svoystvakompanii');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["DIGITAL_HBLOCK_COMPANY_ID"] = $HL_ID;
