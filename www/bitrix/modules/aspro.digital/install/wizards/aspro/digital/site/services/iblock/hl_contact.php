...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproDigitalContactReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproDigitalContactReference', 'TABLE_NAME' => 'b_hlbd_sposobyoplaty');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["DIGITAL_HBLOCK_CONTACT_ID"] = $HL_ID;
