...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproDigitalTizerstReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproDigitalTizerstReference', 'TABLE_NAME' => 'digital_tizers_reference');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["DIGITAL_HBLOCK_TIZERS_ID"] = $HL_ID;
